...
it("Example sending the POST request", () => {
  const requestBody = {
    ...
    xref: "96ce0eb729b38c6feb8579097a6b0705",
    _: 1678976128612,
  };

  const headersData = {
    cookie:
      "_ga=GA1.2.436588987.1678795012; _gid=GA1.2.251687636.1678795012; pubkey=3cad515745c34228ad72053dfee5750c; _gat_gtag_UA_29683426_11=1; lfp=3/14/2023, 1:57:02 PM; pa=1678867614975.85770.8763406514303103next.privat24.ua0.5387709970486083+10; fp=23",
  };
  ...
  cy.request({
    ...
    expect(response.body.data).to.have.property("amount").to.equal("1.0");
    console.log(response);
  });
});
